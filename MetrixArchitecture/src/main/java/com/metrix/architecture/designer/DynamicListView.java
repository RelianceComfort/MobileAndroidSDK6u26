...
public class DynamicListView extends ListView {
    ...
    private Bitmap getBitmapWithBorder(View v) {
        ...
        paint.setColor(Color.parseColor("#360065"));
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mListData, originalItem, getPositionForView(switchView));
    ...
    */
    ...
    public void setListWithEnabling(List<HashMap<String, String>> table, boolean allowChanges) {
    	mListData = (ArrayList<HashMap<String, String>>) table;
    	if (allowChanges) {
    		// taken from init() method ... setting listeners only if changes are allowed
